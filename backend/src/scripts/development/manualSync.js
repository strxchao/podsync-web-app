...
function parseTimestamp(timestampStr) {
  try {
    ...
    // Convert "13/01/2025 13:57:45" to JavaScript Date with proper WIB timezone handling
    ...
    console.log(`Parsed timestamp: ${timestampStr} -> ${date.toISOString()} (WIB: ${date.toLocaleString('id-ID', { timeZone: 'Asia/Jakarta' })})`);
